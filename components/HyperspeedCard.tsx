...
const HyperspeedCard: FC<HyperspeedCardProps> = ({ 
  title = "Experience the Future", 
  description = "Dive into a world of cutting-edge technology and innovation",
  className = "",
  effectOptions = {}
}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(val) => setOpen(val)}>
      <div className={`relative w-full h-96 rounded-2xl overflow-hidden border border-gray-800 bg-black ${className}`}>
        ...
        <div className="absolute top-4 right-4 z-20">
          <DialogTrigger asChild>
            <button
              ...
              className="bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 text-sm text-white/90 hover:bg-white/20 hover:text-white transition-all duration-200 border border-white/20 hover:border-white/40"
            >
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              className="bg-neutral-800/50 border-neutral-600 text-white placeholder:text-neutral-500 resize-none"
            />
          </div>
        </div>
